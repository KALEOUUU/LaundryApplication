...
public class Laporan {
 ...
 public void laporan(Petugas petugas) {
    ...
    System.out.println(jenisLaundry.getNamaJenisLaundry(transaksi.getIdJenisLaundry(i))+"\t"+ transaksi.getBanyaknya(i)+ "kg"+ "\t" +"\t"+ "Rp." + jenisLaundry.getHarga(transaksi.getIdJenisLaundry(i))+ "/kg" + "\t" + "\t" + "Rp."+ jumlah);
    }
